...
{
    /// <summary>
    /// Gets the current tenant when scoped; otherwise null.
    /// </summary>
    TenantId? CurrentTenantId { get; }

    /// <summary>
    /// Gets whether the request has no tenant in ambient context (platform-scoped).
    /// </summary>
    bool IsPlatformScoped { get; }

    /// <summary>
    /// Returns the required tenant id or throws when absent.
    /// </summary>
    TenantId GetRequiredTenantId();

    /// <summary>
    /// Ensures the supplied tenant matches the required ambient tenant scope.
    /// </summary>
    void EnsureMatches(Guid tenantId);
}

/// <summary>
/// Execution-context backed tenant scope.
/// </summary>
